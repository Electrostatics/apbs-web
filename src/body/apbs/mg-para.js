...
class MgPara extends CalctypeBase{
  constructor(props){
    super(props);
    this.state = {
    ...
    return(
      <Col offset={2}>
        <Row gutter={16} style={{marginBottom: 8}}>
          <Col  span={5}>Grid Points Per Processor </Col>
          <Col  span={5}>Coarse Mesh Domain Lengths </Col>
          <Col  span={5}>Fine Mesh Domain Lengths</Col>
          <Col  span={5}># Processors in Parallel</Col>
        </Row>
        
        <Row gutter={16} style={{marginBottom: 8}}>
          <Col  span={5}>{this.renderNumericalField('X-direction','dimenx', this.props.form_values.dimenx)}</Col>
          <Col  span={5}>{this.renderNumericalField('X-direction','cglenx', this.props.form_values.cglenx)}</Col>
          <Col  span={5}>{this.renderNumericalField('X-direction','fglenx', this.props.form_values.fglenx)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','pdimex', this.props.form_values.pdimex)}</Col>
        </Row>
        
        <Row gutter={16} style={{marginBottom: 8}}>
          <Col  span={5}>{this.renderNumericalField('Y-direction','dimeny', this.props.form_values.dimeny)}</Col>
          <Col  span={5}>{this.renderNumericalField('Y-direction','cgleny', this.props.form_values.cgleny)}</Col>
          <Col  span={5}>{this.renderNumericalField('Y-direction','fgleny', this.props.form_values.fgleny)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','pdimey', this.props.form_values.pdimey)}</Col>
        </Row>

        <Row gutter={16} style={{marginBottom: 8}}>
          <Col  span={5}>{this.renderNumericalField('Z-direction','dimenz', this.props.form_values.dimenz)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','cglenz', this.props.form_values.cglenz)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','fglenz', this.props.form_values.fglenz)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','pdimez', this.props.form_values.pdimez)}</Col>
        </Row>
      ...
      <div>
        ...
        <Col>
          <Collapse activeKey={this.state.collapse_active_keys} onChange={this.updateCollapseActiveKeys}>
            ...
            <Panel forceRender={true} header="AMOUNT OF OVERLAP TO INCLUDE BETWEEN THE INDIVIDUAL PROCESSORS' MESHES">
              <Col span={4}> {this.renderNumericalField('', 'ofrac', this.props.form_values.ofrac)} </Col>
            </Panel>
